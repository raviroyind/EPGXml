...
<script type="text/javascript">
    function ShowHideDiv() {
        ...
        document.getElementById('<%=divToken.ClientID %>').style.display = ddlUserType.value == "Admin" ? "block" : "none";
    }
</script>
                                ...
                                <div class="module" id="changelist">
                                    ...
                                    <div>
                                                        ...
                                                        <div class="form-horizontal" style="padding-top: 20px;">
                                                            ...
                                                            <div class="two-columns">
                                                                ...
                                                                <div class="right-column">
                                                                    <asp:Label runat="server" ID="lblMsg" CssClass="bold alert-danger"></asp:Label>
                                                                    <br/>
                                                                    ...
                                                                    <table class="table table-hover table-condensed table-mptt" style="border-collapse: collapse">
                                                                        <tr>
                                                                            <td colspan="6">
                                                                        ...
                                                                        <tr nowrap="nowrap">
                                                                            ...
                                                                            <td nowrap="nowrap">
                                                                                <span>User Type:</span>
                                                                                <asp:DropDownList runat="server" CssClass="dropdown" onchange="ShowHideDiv()" ID="ddlUserType" Width="80px">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="6">
                                                                                <div id="divToken" runat="server" style="display: none;">
                                                                                    <div class="row">
                                                                                        <div class="col-lg-8 pull-left">
                                                                                           <span>Web Service Token:</span>
                                                                                              <asp:TextBox ID="txtAuthenticationTokenAdd"  Width="300" runat="server" Text='<%# Eval("AuthenticationToken") %>'></asp:TextBox>
                                                                                            <asp:LinkButton ID="btnGenerateTokenAdd" runat="server" CssClass="btn btn-xs btn-success" ToolTip="Auto generate random token string." Text="" OnClick="btnGenerateTokenAdd_OnClick">
                                                                                            <i class="glyphicon glyphicon-refresh"></i> <span class="bold"></span>
                                                                                        </asp:LinkButton>
                                                                                        </div>
                                                                    ...
                                                                    <div id="grid" runat="server">
                                                                        ...
                                                                        <asp:GridView ID="gvUsers" runat="server" Width="100%" DataKeyNames="UserName" AutoGenerateColumns="False" HeaderStyle-CssClass="visible-desktop" CssClass="table table-striped table-bordered table-hover table-condensed table-mptt" GridLines="None"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="User Type" ItemStyle-Width="100">
                                                                                    <ItemTemplate>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Web Service Auth-Token" ItemStyle-Width="300">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblAuthenticationToken" runat="server" Text='<%# Eval("AuthenticationToken") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <EditItemTemplate>
                                                                                        <asp:TextBox ID="txtAuthenticationToken" CssClass="input-lg input-xlarge" Style="font-size: 12px; font-weight: bold; width: 88%;" runat="server" Text='<%# Eval("AuthenticationToken") %>'></asp:TextBox>
                                                                                        <asp:LinkButton ID="btnGenerateToken" runat="server" CssClass="btn btn-xs btn-success" ToolTip="Auto generate random token string." Text="" OnClick="btnGenerateToken_Click">
                                                                                    <i class="glyphicon glyphicon-refresh"></i> <span class="bold"></span>
                                                                                        </asp:LinkButton>
                                                                                    </EditItemTemplate>
                                                                                ...
                                                                                <asp:CommandField ButtonType="Image" EditImageUrl="../CSS/edit.png" HeaderText="Actions" DeleteImageUrl="../CSS/delete.png" DeleteText="Delete" EditText="Edit" ShowEditButton="true" CancelImageUrl="../CSS/cancel.png" CancelText="Cancel" UpdateImageUrl="../CSS/Save.png" ValidationGroup="grv" CausesValidation="True" UpdateText="Save" ShowDeleteButton="true" ItemStyle-Width="150">
                                                                                    <ItemStyle Width="150px" />
                                                                                </asp:CommandField>
                                                                            </Columns>
                                                                        </asp:GridView>
                                        ...
                                        <asp:UpdateProgress runat="server"
                                            ...
                                            DynamicLayout="true">
                                            <ProgressTemplate>
                                                <div style="position: absolute; width: 100%; height: 100%; left: 40%;">

...
namespace XmlParser.Admin
{
    public partial class Dashboard : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                BindGrid();
                this.Form.DefaultButton = btnLnkAdd.UniqueID;
            }
        ...
        protected void Insert(object sender, EventArgs e)
        {
            ...
            var inValid = false;
            if (!string.IsNullOrEmpty(txtAuthenticationTokenAdd.Text))
            {
                foreach (var item in Illegal.Where(item => txtAuthenticationTokenAdd.Text.Contains(item)))
                {
                    inValid = true;
                }
            ...
            if (inValid)
            {
                lblMsg.Text = "Authentication token cannot contain any of following characters \"+,=,&,%\"";
                return;
            }
            ...
            using (var dataContext = new EPGDataModel())
            {
                ...
                var user = new User
                {
                    ...
                    AuthenticationToken =txtAuthenticationTokenAdd.Text
                };
        ...
        private  void ClearForm()
        {
            ...
            txtAuthenticationTokenAdd.Text = string.Empty;
            divToken.Style.Add(HtmlTextWriterStyle.Display, "none");
        }
        protected void gvUsers_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                (e.Row.Cells[5].Controls[2] as ImageButton).Attributes["onclick"] =
        ...
        protected void gvUsers_OnRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            var token = (row.FindControl("txtAuthenticationToken") as TextBox).Text;
            ...
            {
                foreach (var item in Illegal.Where(item => token.Contains(item)))
                {
                    inValid = true;
                }
        ...
        protected void btnGenerateToken_Click(object sender, EventArgs e)
        {
            ...
            var txt=(TextBox) btn.Parent.Controls[1];
            txt.Text = Convert.ToString(Guid.NewGuid());
            lblMsg.Text = string.Empty;
        }
         
        protected void btnGenerateTokenAdd_OnClick(object sender, EventArgs e)
        {
            txtAuthenticationTokenAdd.Text = Convert.ToString(Guid.NewGuid());
            divToken.Style.Add(HtmlTextWriterStyle.Display, "block");
            lblMsg.Text = string.Empty;
        }
    }
}
